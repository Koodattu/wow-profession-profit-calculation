...
export const env = {
  ...
  REALM_HISTORY_INTERVAL_HOURS: positiveInteger("REALM_HISTORY_INTERVAL_HOURS", 1),
  ...
  RAW_SNAPSHOT_RETENTION_DAYS: positiveInteger("RAW_SNAPSHOT_RETENTION_DAYS", 30),
  HISTORY_ARCHIVE_DIR: process.env.HISTORY_ARCHIVE_DIR ?? resolve(import.meta.dir, "../../../backups/price-history"),
